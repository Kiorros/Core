...
<table cellspacing="0" class="list">
    ...
    <td width="65%" class="{altclass}">
        <h4 style="padding-left: {MESSAGES->indent_cnt}px">
            ...
            <div style="position: absolute; z-index: 210; margin-left: -19px; margin-top: 7px; height: {mod_treeview->line_width}px; width: {MESSAGES->h_width}px; background-color: {mod_treeview->line_color}; display: inline;"><img src="{URL->HTTP_PATH}/images/trans.gif" /></div>
            <div style="position: absolute; z-index: 200; margin-left: -19px; margin-top: -{MESSAGES->v_margin}px; height: {MESSAGES->v_height}px; width: {mod_treeview->line_width}px; background-color: {mod_treeview->line_color}; display: inline;"><img src="{URL->HTTP_PATH}/images/trans.gif" /></div>&nbsp;
